                ...
                <Alert className="mb-4">
                  ...
                  <AlertDescription>
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                      ...
                      <li><strong>Start Time</strong> - время начала занятия (формат: ЧЧ:ММ)</li>
                      <li><strong>End Time</strong> - время окончания занятия (формат: ЧЧ:ММ)</li>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      Названия колонок могут быть также на русском языке: Предмет, День, Время начала, Время конца, Кабинет, Преподаватель.
                    </p>
                    <div className="mt-3">
                      <a 
