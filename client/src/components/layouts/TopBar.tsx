...
const TopBar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 glass-sidebar dark:bg-sidebar-background text-sidebar-foreground h-20 flex items-center px-4 z-[90] shadow-lg">
